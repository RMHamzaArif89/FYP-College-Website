...
function History() {
  return (
    <>
      ...
      <div className="exPrinciples">
        <div className="exPrinciplesHeading">EX-Principles of GGCSF</div>
        <table className='exPrinciplesTable'>
          {
            Principles.map((data) =>
              <tr>
                <td className='principlesName'>{data.name}</td>
                <td>{data.date}</td>
              </tr>
            )
          }
